-- Tabelle per i badge e premi degli utenti - Versione corretta con i nomi tabelle aggiornati
...
CREATE INDEX IF NOT EXISTS idx_user_stats_game_id ON user_stats(game_id);

-- Verifica l'esistenza della tabella user_rewards
...
INSERT INTO user_stats (user_id, game_id, games_played, correct_answers, wrong_answers, total_points, best_score, avg_time_per_question)
VALUES 
